...
![Start](../assets/WDAC_policy/start.png)
 
- Add or remove programs  

![Add or remove programs](../assets/WDAC_policy/add_remove_programs.png)
 
- Search apps or Scroll through the list and look for anything matching the types above.  

![Search Apps](../assets/WDAC_policy/search_apps.png)
...
![Unistall](../assets/WDAC_policy/uninstall.png)
