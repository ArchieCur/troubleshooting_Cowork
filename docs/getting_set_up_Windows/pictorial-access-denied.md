...
- Find the Cowork Readiness Checker application, check for it in your Downloads folder  
- Right-click on it
- Select **Run as administrator**  

![Right click readiness Checker to run as admin](../assets/fix_access_denied/run_readiness_as_admin.png)  
...
![Local Security Policy](../assets/fix_access_denied/local_security_policy.png)

- Go to **Local Policies → User Rights Assignment**  

![User Rights Assignment](../assets/fix_access_denied/user_rights_access.png)

- Look for **Log on as a service**  

![Log on as a Service](../assets/fix_access_denied/log_on_as_a_service.png)
...
![ALL SERVICES](../assets/fix_access_denied/all_services.png)
...
![Advanced](../assets/fix_access_denied/advanced.png)

- **Click** Find Now.  

![Find Now](../assets/fix_access_denied/find_now.png)
...
![OK](../assets/fix_access_denied/ok.png)  

![Apply](../assets/fix_access_denied/apply.png)
